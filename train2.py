...
def train_model(X, Y, i, learning_rate):
...
if __name__ == "__main__":
    X, Y = import_data()
    p1 = multiprocessing.Process(target=train_model, args=(X, Y, 0, 0.007)) 
    p2 = multiprocessing.Process(target=train_model, args=(X, Y, 1, 0.007)) 
    p3 = multiprocessing.Process(target=train_model, args=(X, Y, 2, 0.007)) 
    p4 = multiprocessing.Process(target=train_model, args=(X, Y, 3, 0.007)) 
